...
local storage, duration = 1.4, 0.8
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_GREET] = "Saudações, |PLAYERNAME|.",
			[MESSAGE_FAREWELL] = "Tchau, |PLAYERNAME|.",
			[MESSAGE_BUY] = "Voce quer comprar |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| ouros?",
			[MESSAGE_ONBUY] = "Tome isto.",
			[MESSAGE_BOUGHT] = "Comprou |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ouros.",
			[MESSAGE_SELL] = "Você quer vender |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| ouros?",
			[MESSAGE_ONSELL] = "Olha Você aqui, |TOTALCOST| ouros.",
			[MESSAGE_SOLD] = "Vendida |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ouros.",
			[MESSAGE_MISSINGMONEY] = "Você não tem dinheiro suficiente.",
			[MESSAGE_NEEDMONEY] = "Você não tem dinheiro suficiente.",
			[MESSAGE_MISSINGITEM] = "Você não tem tantos.",
			...
			[MESSAGE_IDLETIMEOUT] = "Adeus.",
			[MESSAGE_WALKAWAY] = "Tchau.",
			[MESSAGE_DECLINE] = "Então não.",
			[MESSAGE_SENDTRADE] = "Claro, basta navegar pelos meus produtos.",
			[MESSAGE_NOSHOP] = "Desculpe, não estou oferecendo nada.",
			[MESSAGE_ONCLOSESHOP] = "Obrigado, volte sempre que precisar de outra coisa.",
			[MESSAGE_ALREADYFOCUSED] = "|PLAYERNAME|, Eu já estou falando com você.",
			[MESSAGE_WALKAWAY_MALE] = "Até mais",
			[MESSAGE_WALKAWAY_FEMALE] = "Fique bem."
		}
	}
