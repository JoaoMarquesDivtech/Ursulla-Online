...
enum CombatType_t : uint16_t {
	...
	COMBAT_SONGDAMAGE = 1 << 12, 
	COMBAT_BLOODDAMAGE = 1 << 13,
	COMBAT_AIRDAMAGE = 1 << 14,
	COMBAT_REALDAMAGE = 1 << 15,
	COMBAT_COUNT = 16,
...
enum ConditionType_t {
	...
	CONDITION_SONGDAMAGE = 1 << 28,
	CONDITION_BLOODDAMAGE = 1 << 29,
	CONDITION_AIRDAMAGE = 1 << 30, 
	CONDITION_REALDAMAGE = 1 << 31
};
